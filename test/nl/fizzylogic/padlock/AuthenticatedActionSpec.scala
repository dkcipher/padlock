...
class AuthenticatedActionSpec extends PlaySpec with OneAppPerSuite {
  "AuthorizationSupport#AuthenticatedAction" should {
    ...
    val action = controller.AuthenticatedAction {
      Ok("")
    }
